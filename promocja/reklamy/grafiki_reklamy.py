...
def grafika(W, H, naglowek_sz, top, story=False):
    ...
    y += 22
    y = tekst_lam(d, 70, y, "Stowarzyszenie, koło gospodyń, OSP, klub sportowy albo 3 osoby bez rejestracji.", f_lato(34 if story else 28), TUSZ, W - 140 - (0 if story else sz + 40), lh=int((34 if story else 28) * 1.35))
    y += 34
